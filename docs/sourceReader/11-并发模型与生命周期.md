...
| 委派分发 | `run_agent.py` | `AIAgent._dispatch_delegate_task()` @8472 |
...
| 会话持久化锁 | `run_agent.py` | `AIAgent._persist_session()` @2020 |
...
- `run_agent.py:AIAgent._dispatch_delegate_task()`，约在 `8472` 行
